              ...
              <a href="#" class="list-group-item " style="background:#187F7F;color:#fff;text-align:center;">Category
                  ...
                  if($qResult){
                    while($result = $qResult->fetch_assoc()){
                      ?>
         <a href="category.php?cat='<?php echo $result['cname'];?>' " style="color:#187F7F;"><li class="list-group-item"><?php echo $result['cname'];?>
          ...
          <div class="col-md-6">
              ...
              <!-- /.div -->
                  ...
                  <!-- /.col -->
                <?php
                $query = "SELECT * FROM circular order by cId DESC";
