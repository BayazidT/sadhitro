        ...
        <div class="row" style="margin-top:10px;">
         ...
         <a href="catc.php?cat='<?php echo $result['cname'];?>' " style="color:#187F7F;"><li class="list-group-item"><?php echo $result['cname'];?>
          ...
          <div class="col-md-6">
              <div>
                  <ol class="breadcrumb">
                      <li><a href="#">Circulars/<?php echo $search; ?>  </a></li>
                </ol>
              ...
              <!-- /.div -->
                  ...
                  <!-- /.col -->
                <?php
                $query = "SELECT * FROM circular WHERE (title LIKE '%$search%')  OR (description LIKE '%$search%') OR (category LIKE '%$search%') order by cId DESC limit $start_form, $per_page";
